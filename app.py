...
def streamlit_config():
    ...
    def setting_bg():
        st.markdown(f""" <style>.stApp {{
                            background:url("https://cdn.dribbble.com/users/1815739/screenshots/4740027/airbnbexp_gif1.gif");
...
class sql:
    ...
    def create_table():
        ...
        try:
            ...
            sathish = psycopg2.connect(host='localhost',
                                    user='postgres',
                                    password='SK',
                                    database='retail_forecast')
            cursor = sathish.cursor()
    ...
    def data_migration():
        ...
        try:
            f = pd.read_csv(r'C:\Users\sathi\OneDrive\Desktop\Guvi Capstone projects\Retail-Sales-Forecast-main\dataset\df_sql.csv')
            df = pd.DataFrame(f)
    ...
    def predict_weekly_sales():
        ...
        if button:
            with st.spinner(text='Processing...'):
                ...
                with open(r'C:\Users\sathi\OneDrive\Desktop\Guvi Capstone projects\Retail-Sales-Forecast-main\model1_markdown.pkl', 'rb') as f:
                    model = pickle.load(f)
